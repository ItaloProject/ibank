...
const TYPE_COLORS: Record<string, string> = {
  dividendo: "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400",
  rendimento: "bg-amber-500/15 text-amber-600 dark:text-amber-400",
  juros: "bg-muted text-muted-foreground",
};
