              ...
              <div key={m.id} className={cn("flex", m.role === "user" ? "justify-end" : "justify-start")}>
                <div
                  className={cn(
                    ...
                    m.role === "user"
                      ? "bg-amber-500/20 border border-amber-500/30 text-foreground rounded-br-md"
                ...
                >
                  ...
                  {m.pdfReady && (
                    <button
                      ...
                      className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-amber-500 px-3 py-2 text-xs font-semibold text-amber-950 hover:bg-amber-400 transition-colors"
                    >
          ...
          <div className="border-t border-white/10 px-3 pt-2 pb-1">
            ...
            >
              <input
                ...
                className="flex-1 rounded-xl border border-white/10 bg-white/5 px-3 py-2.5 text-sm text-white placeholder:text-white/30 focus:outline-none focus:ring-1 focus:ring-amber-500/50 min-h-11"
              />
              <button
                type="submit"
                disabled={busy || !input.trim()}
                className="flex h-11 w-11 items-center justify-center rounded-xl bg-amber-500 text-amber-950 hover:bg-amber-400 disabled:opacity-40 touch-manipulation transition-colors"
              >
